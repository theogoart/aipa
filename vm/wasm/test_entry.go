...
import (
	...
	//"encoding/json"
	//"path/filepath"
	//"github.com/aipadad/core/vm/testcase"
	"github.com/aipadad/aipa/vm/wasm/exec"
	//"github.com/aipadad/core/vm/wasm"
	//"reflect"
	//"unsafe"
	"os"
	//"bytes"
	//"github.com/aipadad/core/contract"
	//"github.com/aipadad/core/contract"
	//"github.com/aipadad/core/db"
	//"github.com/aipadad/core/role"
	//"github.com/aipadad/core/config"
...
func TestContract1() {
	...
	//test
	code, err := ioutil.ReadFile("C:\\Users\\stewa\\go\\src\\github.com\\aipadad\\core\\vm\\testcase\\test_data2\\contract.wasm")
	if err != nil {
		fmt.Println("error in read file", err.Error())
		return
	}
...
func TestRawContract() {
	engine := exec.NewVMEngine(nil, "product")
	//test
	code, err := ioutil.ReadFile("C:\\Users\\stewa\\go\\src\\github.com\\aipadad\\core\\vm\\testcase\\test_data2\\rawcontract.wasm")
	if err != nil {
		fmt.Println("error in read file", err.Error())
		return
	}
...
func init() {
	defer log.Flush()
	logger, err := log.LoggerFromConfigAsFile("C:\\Users\\stewa\\go\\src\\github.com\\aipadad\\config\\log.xml")
	if err != nil {
...
func main() {
	/*
	defer log.Flush()
	logger, err := log.LoggerFromConfigAsFile("C:\\Users\\stewa\\go\\src\\github.com\\aipadad\\core\\log.xml")
	if err != nil {
		log.Critical("err parsing config log file", err)
		os.Exit(1)
		return
