...
func (nc *NativeContract) newAccount(ctx *Context) berr.ErrCode {
	Abi := abi.GetAbi()
	newaccount := abi.UnmarshalAbiEx("aipa", Abi, "newaccount", ctx.Trx.Param)
...
func (nc *NativeContract) transfer(ctx *Context) berr.ErrCode {
	Abi := abi.GetAbi()
	transfer := abi.UnmarshalAbiEx("aipa", Abi, "transfer", ctx.Trx.Param)
...
func (nc *NativeContract) setDelegate(ctx *Context) berr.ErrCode {
	Abi := abi.GetAbi()
	param := abi.UnmarshalAbiEx("aipa", Abi, "setdelegate", ctx.Trx.Param)
...
func (nc *NativeContract) grantCredit(ctx *Context) berr.ErrCode {
	Abi := abi.GetAbi()
	param := abi.UnmarshalAbiEx("aipa", Abi, "grantcredit", ctx.Trx.Param)
	if param == nil || len(param) <= 0 {
		return berr.ErrContractParamParseError
	}
...
func (nc *NativeContract) cancelCredit(ctx *Context) berr.ErrCode {
	Abi := abi.GetAbi()
	param := abi.UnmarshalAbiEx("aipa", Abi, "cancelcredit", ctx.Trx.Param)
	if param == nil || len(param) <= 0 {
		return berr.ErrContractParamParseError
	}
...
func (nc *NativeContract) transferFrom(ctx *Context) berr.ErrCode {
	Abi := abi.GetAbi()
	transfer := abi.UnmarshalAbiEx("aipa", Abi, "transferfrom", ctx.Trx.Param)
	if transfer == nil || len(transfer) <= 0 {
		return berr.ErrContractParamParseError
	}
...
func (nc *NativeContract) deployCode(ctx *Context) berr.ErrCode {
	Abi := abi.GetAbi()
	param := abi.UnmarshalAbiEx("aipa", Abi, "deploycode", ctx.Trx.Param)
	if param == nil || len(param) <= 0 {
		return berr.ErrContractParamParseError
	}
...
func (nc *NativeContract) deployAbi(ctx *Context) berr.ErrCode {
	Abi := abi.GetAbi()
	param := abi.UnmarshalAbiEx("aipa", Abi, "deployabi", ctx.Trx.Param)
	if param == nil || len(param) <= 0 {
		return berr.ErrContractParamParseError
	}
...
func (nc *NativeContract) stake(ctx *Context) berr.ErrCode {
	Abi := abi.GetAbi()
	transfer := abi.UnmarshalAbiEx("aipa", Abi, "stake", ctx.Trx.Param)
	if transfer == nil || len(transfer) <= 0 {
		return berr.ErrContractParamParseError
	}
...
func (nc *NativeContract) unstake(ctx *Context) berr.ErrCode {
	Abi := abi.GetAbi()
	transfer := abi.UnmarshalAbiEx("aipa", Abi, "unstake", ctx.Trx.Param)
	if transfer == nil || len(transfer) <= 0 {
		return berr.ErrContractParamParseError
	}
...
func (nc *NativeContract) claim(ctx *Context) berr.ErrCode {
	Abi := abi.GetAbi()
	transfer := abi.UnmarshalAbiEx("aipa", Abi, "claim", ctx.Trx.Param)
	if transfer == nil || len(transfer) <= 0 {
		return berr.ErrContractParamParseError
	}
...
func (nc *NativeContract) regDelegate(ctx *Context) berr.ErrCode {
	Abi := abi.GetAbi()
	param := abi.UnmarshalAbiEx("aipa", Abi, "regdelegate", ctx.Trx.Param)
	if param == nil || len(param) <= 0 {
		return berr.ErrContractParamParseError
	}
...
func (nc *NativeContract) unregDelegate(ctx *Context) berr.ErrCode {
	Abi := abi.GetAbi()
	param := abi.UnmarshalAbiEx("aipa", Abi, "unregdelegate", ctx.Trx.Param)
	if param == nil || len(param) <= 0 {
		return berr.ErrContractParamParseError
	}
...
func (nc *NativeContract) voteDelegate(ctx *Context) berr.ErrCode {
	Abi := abi.GetAbi()
	param := abi.UnmarshalAbiEx("aipa", Abi, "votedelegate", ctx.Trx.Param)
	if param == nil || len(param) <= 0 {
		return berr.ErrContractParamParseError
	}
